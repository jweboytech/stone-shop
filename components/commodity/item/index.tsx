...
const CommodityItem = ({ data }: { data: Commodity }) => {
  ...
  const handleNavigate = () => {
    router.push(`/shop/commodity/${data.id}`);
  };
    ...
    <div className="group cursor-pointer relative" onClick={handleNavigate}>
      ...
      <div className="relative">
        <Image
          ...
          width={380}
          height={380}
          className="group-hover:animate-zoom-fade-small absolute z-10 left-0 top-0 h-full w-100 h-100"
          src={data.mainPics[1]}
        />
        <Image
          alt={data.mainPics[1]}
          className="-z-10 visible group-hover:invisible transition-all duration-300 w-100 h-100"
          width={380}
          height={380}
          src={data.mainPics[0]}
        />
