...
const ShippingPolicyPage = () => {
  return (
    <div className="mx-62 px-10 pt-20">
      <div className="py-10 px-4">
        ...
        <p className="mb-6">
          All orders are custom made on demand. Due to this, orders are
          processed within 5-10 business days. Orders are not shipped or
        ...
        <p className="mb-6">
          Our <span className="underline">Return & Refund Policy</span> provides
          detailed information about options and procedures for returning your
          order.
        </p>
      </div>
    </div>
