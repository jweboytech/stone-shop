...
const TeamsConditionsPage = () => {
  return (
    <div className="text-18">
      ...
      <p>
        This website is operated by Celeste Adore. Throughout the site, the
        terms &quot;we&quot;,&quot; us&quot;, &quot;our&quot; refer to Celeste
        Adore. Celeste Adore offers this website, including all information,
        tools, and Services available from this website to you the user,
      ...
      <p>
        Any new features or tools added to the current store are also subject to
        the Terms of Service. You can review the most recent version of the
        Terms of Service at any time on this page.
      </p>
      <h3 className="font-medium text-22 mt-15 mb-6 uppercase">
        <strong>Celeste Adore Store Terms</strong>
      </h3>
      <p>
        ...
        You must not transmit any worms or viruses or any code of destruction
        nature. A breach or violation of any of the Terms will result in an
        immediate termination of your Services.
      </p>
      <h3 className="font-medium text-22 mt-15 mb-6 uppercase">
        <strong>Our Store General Conditions</strong>
      </h3>
      <p>
      ...
      <p>
        We are not responsible if information made available on this website is
        not accurate, complete or current. The material on this website is
        ...
        reliance on the material on this site is at your own risk. This website
        ...
        reserve the right to modify the contents of this website at any time,
        but we have no obligation to update any information on our website. You
        agree that it is your responsibility to monitor changes to our site
      </p>
      <h3 className="font-medium text-22 mt-15 mb-6 uppercase">
        <strong>Modification to the Prices & Services</strong>
      </h3>
      <p>
        Prices for our product are subjected to change without notice. The
        prices displayed on our website are those current at the time we accept
        your order. We reserve the right at any time to modify or discontinue
        the Service (or any part or content thereof) without notice at any time.
        We reserve the right, but not obligated, to limit the sales of our
        ...
        to limit the quantity of products or services we offer. All product
        description or product prices are subject to change at any time without
        notice, at our sole discretion. We also reserve the right o discontinue
        any products at any time. Any offer for any product or service made on
      ...
      <p>
        We reserve the right to refuse any order you placed with us. We may
        limit or cancel quantities purchased per person or per order. These
        ...
        and/or shipping address. Under any circumstances that we make a change
        to or cancel an order, we may attempt to notify you by your mobile
        number or email address provided at the time the order was made. We
        reserve the right to limit or prohibit orders that, in our sole
        judgment, appear to be placed by dealers, resellers or distributors.
      </p>
      <p>
        You agree to provide your current, complete and exact purchase and
        account information for all purchases made at our store. You agree to
        promptly update your account and other information such as email address
      ...
      <p>
        Third-party links on this website may direct you to third-party websites
        that are not affiliated with us. Certain content, products and services
        may include materials from third parties. We are not responsible for
        ...
        materials or websites, or of any other materials, products, or Services
        of third-parties.
      </p>
      <h3 className="font-medium text-22 mt-15 mb-6 uppercase">
      ...
      <p>
        ...
        comply with any of our terms and conditions, we reserve the right to
        terminate this agreement at any time without notice and you will remain
        liable for all accounts due up to and including the date of termination;
      ...
      <p>
        ...
        Terms of Service by posting updates and changes to our website at any
        given time. It is your responsibility to check our website for any
        changes or updates to our Terms of Service.
      </p>
      <h3 className="font-medium text-22 mt-15 mb-6 uppercase">
